...
# }
CONFIG = {
    "train_img_dir": "autodl-tmp/dataset/coco/train2017",
    "train_annotation_file": "autodl-tmp/dataset/coco/annotations/captions_train2017.json",
    # "train_annotation_file": "autodl-tmp/sbg_output/train_finescore0.3.json",
}
...
class COCOCaption(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.tokenizer is None:
            # 当 tokenizer 为 null 时，返回原始文本字符串
            text_input = text
        else:
